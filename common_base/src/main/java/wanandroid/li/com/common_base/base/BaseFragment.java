...
//    public TwinklingRefreshLayout mSwipeRefreshLayout;
...
//    protected void initSwipeRefreshLayout(int id){
//        mSwipeRefreshLayout =  rootView.findViewById(id);
//        if (null!= mSwipeRefreshLayout){
//            mSwipeRefreshLayout.setFloatRefresh(true);
//            ProgressLayout header = new ProgressLayout(mContext);
//            header.setColorSchemeResources(R.color.red);
